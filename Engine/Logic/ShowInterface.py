...
def show_UI(handler, centre):
    ...
    test_cue = {
        ...
        "Dialog": "blah blah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah blahblah blah"
    }
